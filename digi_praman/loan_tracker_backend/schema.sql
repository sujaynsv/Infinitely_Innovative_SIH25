...
CREATE EXTENSION IF NOT EXISTS pgcrypto;  -- for gen_random_uuid (if you want it)
...
-- Optional, if you want org-scoped unique emails:
-- ALTER TABLE users ADD CONSTRAINT users_org_email_unique UNIQUE (_org_id, email);
